...
func TestRuleParseResourceID(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			InputID:       "aws.partner/example.com/example/18554d09-58ff-aa42-ba9c-c4c33899006f/test",
			ExpectedPart0: "aws.partner/example.com/example/18554d09-58ff-aa42-ba9c-c4c33899006f",
			ExpectedPart1: "test",
		},
		{
